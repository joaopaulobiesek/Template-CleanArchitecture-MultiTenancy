        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestBodyEncrypted = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_Active",
                schema: "dbo",
                table: "AuditLog",
                column: "Active");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_Active_ExecutedAt",
                schema: "dbo",
                table: "AuditLog",
                columns: new[] { "Active", "ExecutedAt" })
                .Annotation("SqlServer:Include", new[] { "UserId", "UserName", "DurationMs", "Success", "Action", "Category" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_TenantId_ExecutedAt",
                schema: "dbo",
                table: "AuditLog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_UserId_ExecutedAt",
                schema: "dbo",
                table: "AuditLog",
