...
namespace Template.Application.Domains.V1.Identity.Users.Queries.GetRoles;
...
{
    public GetRolesQueryHandler(HandlerDependencies<GetRolesQuery, IEnumerable<KeyValuePairVM>> dependencies) : base(dependencies)
    {
    }
